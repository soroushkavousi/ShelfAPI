...
public class GetProductByUserQueryHandler(IProductDbContext dbContext, IFusionCache cache)
    : IRequestHandler<GetProductByUserQuery, Result<ProductUserView>>
{
    public async Task<Result<ProductUserView>> Handle(GetProductByUserQuery request, CancellationToken cancellationToken)
    {
